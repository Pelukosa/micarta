...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    ...
    <?php $template->renderPanelMenu("categories");?>
                            ...
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded p-3 bg-green-600"><i
                                            class="fa fa-utensils fa-2x fa-fw fa-inverse"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                                    <h5 class="font-bold uppercase text-gray-500">Categorías</h5>
                                    <h3 class="font-bold text-3xl">4 <span class="text-green-500"><i
                        ...
                        <div class="flex flex-row items-center">
                            <div class="flex-shrink pr-4">
                                <div class="rounded p-3 bg-orange-600"><i
                                        class="fas fa-book-open fa-2x fa-fw fa-inverse"></i></div>
                            </div>
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-500">Productos</h5>
                                <h3 class="font-bold text-3xl">72 <span class="text-orange-500"><i
